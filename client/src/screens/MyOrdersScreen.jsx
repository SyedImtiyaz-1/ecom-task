...
const MyOrdersScreen = () => {
  ...
  return (
    <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg shadow-lg">
      <h1 className="text-3xl text-center font-extrabold text-gray-900 mb-6">My Orders</h1>
      {orders.length === 0 ? (
        <div className="text-center py-10">
          <p className="text-gray-600 text-lg">You have no orders yet.</p>
          <Link to="/" className="mt-4 inline-block bg-gray-500 text-white hover:text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition-colors">
            Add Some Products Dude..
          </Link>
        </div>
      ) : (
