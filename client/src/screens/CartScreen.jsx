    ...
    <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg shadow-lg">
      ...
      {cartItems.length === 0 ? (
        <div className="text-center py-10">
          ...
          <Link to="/" className="mt-4 inline-block bg-gray-500 text-white px-6 py-3 rounded-lg hover:bg-gray-600 transition-colors">
            Add Some Products Dude Then, Come Here..
          </Link>
        </div>
      ) : (
          ...
          <div className="lg:col-span-1">
            <div className="border border-gray-200 rounded-lg p-6">
              ...
              <div className="mt-6">
                <Link
                  to="/checkout"
                  className="w-full flex items-center justify-center rounded-md border border-transparent bg-yellow-400 px-6 py-3 text-base font-medium text-black hover:text-white shadow-sm hover:bg-gray-800"
                >
                  Proceed to Checkout
                </Link>
              </div>
